...
APIs (see API Audience definition (#219)). While this is optional
for component-internal (#219) APIs, we recommend doing so to profit from
...
contain *self-contained YAML files* that each describe one API (exception see #234).
