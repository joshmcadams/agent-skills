...
- We prefer systems to be truly RESTful[^fielding-restful]

[^fielding-restful]: Per definition of R.Fielding REST APIs have to support
...
Law, aka [The
Robustness Principle](http://en.wikipedia.org/wiki/Robustness_principle) (see also [RFC 1122](https://tools.ietf.org/html/rfc1122)):
...
- Book:
[Irresistible
APIs: Designing web APIs that developers will love](https://www.amazon.de/Irresistible-APIs-Designing-that-developers/dp/1617292559)
- Book:
[REST
in Practice: Hypermedia and Systems Architecture](http://www.amazon.de/REST-Practice-Hypermedia-Systems-Architecture/dp/0596805829)
- Book: [Build APIs You
Won't Hate](https://leanpub.com/build-apis-you-wont-hate)
...
API as a Product is closely related to the API First principle ([#100](general-guidelines.md#rule-100))
