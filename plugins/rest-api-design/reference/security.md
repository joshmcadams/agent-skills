...
## MUST secure endpoints {#rule-104}
...
may use other OAuth 2.0 authorization flows as defined by [RFC 6749](https://tools.ietf.org/html/rfc6749).
Please consult the
[OpenAPI OAuth 2.0 Authentication](https://swagger.io/docs/specification/authentication/oauth2/)
